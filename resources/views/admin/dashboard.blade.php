            ...
            <div class="row mt" >
                ...
                <div class="grey-panel pn donut-chart">
                  ...
                  <div class="row">
                    <div class="col-sm-5 col-xs-5 goleft">
                      <p>Tổng sản phẩm :{{$productCount}}</p>
                    </div>
                    <div class="col-sm-7 col-xs-7">
                      <h2>{{ $productCount / 1000}}%</h2>
                    </div>
                  </div>
                </div>
                <!-- /grey-panel -->
              ...
              <div class="col-md-4 col-sm-4 ">
                <div class="darkblue-panel pn">
                  ...
                  <footer>
                    <div class="pull-left">
                        <?php $allMember = $adminCount + $userCount ?>
                      <h5>  <i class="far fa-user ml-05"></i> {{$allMember}}</h5>
                    </div>
                    <div class="pull-right">
                      <h5>{{$allMember/1000}}%</h5>
                    </div>
                  </footer>
                </div>
                <!--  /darkblue panel -->
