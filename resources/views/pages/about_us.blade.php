...
<?php
    use App\Banner;
    $bannersM = Banner::banners('about-us');
    if(!$bannersM){
...
<div class="about-story pt-95 pb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="story-img">
                    <img src="{{asset('frontend/assets/img/banner/11.png')}}" alt="">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="banner-wrapper-4 mb-30">
                    <a href="#"><img src="{{asset('frontend/assets/img/banner/37.jpg')}}" alt=""></a>
            ...
            <div class="col-lg-4">
                <div class="banner-wrapper-4 mb-30">
                    <a href="#"><img src="{{asset('frontend/assets/img/banner/21.jpg')}}" alt=""></a>
            ...
            <div class="col-lg-4">
                <div class="banner-wrapper-4 mb-30">
                    <a href="#"><img src="{{asset('frontend/assets/img/banner/22.jpg')}}" alt=""></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="choose-banner-wrapper f-right">
                    <img src="{{asset('frontend/assets/img/banner/38.jpg')}}" alt="">
...
<div class="team-area">
    <img src="{{asset('frontend/assets/img/banner/39.jpg')}}" alt="">
</div>
<!-- testimonials area start -->
<div class="testimonials-area pt-100 pb-95 bg-img" style="background-image: url({{asset('frontend/assets/img/bg/7.jpg')}})">
    <div class="container">
